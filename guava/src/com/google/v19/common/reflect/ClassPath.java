...
public final class ClassPath {
  ...
  public static class ResourceInfo {
     ...
     *                                class loader, despite physically existing in
     *                                the class path.
     */
  ...
  public static final class ClassInfo extends ResourceInfo {
     ...
     *
     * @throws LinkageError when there were errors in loading classes that this
     *                      class depends on. For example,
  ...
  abstract static class Scanner {
     ...
     * JAR File Specification</a>. If {@code manifest} is null, it means the jar
     * file has no manifest, and an empty set will be returned.
     */
    @VisibleForTesting
     ...
     * <a href=
     * "http://docs.oracle.com/javase/8/docs/technotes/guides/jar/jar.html#Main_Attributes">
     * JAR File Specification</a>. Even though the specification only talks about
