 ...
 * Provides convenience methods such as {@link #isPublic} and
 * {@link #isPackagePrivate}.
 * 
 * @author Ben Yu
 */
class Element extends AccessibleObject implements Member {
   ...
   * 
   * <p>
   * Note that a method may still be effectively "final", or non-overridable when
   * it has no {@code final} keyword. For example, it could be private, or it
   * could be declared by a final class. To tell whether a method is overridable,
