...
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B>
   ...
   *   &#64;code
   *
   *   static final ImmutableTypeToInstanceMap<Handler<?>> HANDLERS = ImmutableTypeToInstanceMap.<Handler<?>>builder()
   *       .put(new TypeToken<Handler<Foo>>() {
  ...
  public static final class Builder<B> {
    ...
    /**
     * Returns a new immutable type-to-instance map containing the entries provided
     * to this builder.
     *
