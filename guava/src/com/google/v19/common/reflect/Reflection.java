...
public final class Reflection {
   ...
   * only parses the class name, without attempting to define the {@link Package}
   * and hence load files.
   */
   ...
   * Language Specification (section 6.7). Unlike {@link Class#getPackage}, this
   ...
   * because static state hurts system maintainability and testability. In cases
   * when you have no choice while inter-operating with a legacy framework, this
   * method helps to keep the code less ugly.
   *
