...
import static com.google.v19.common.math.DoubleUtils.IMPLICIT_BIT;
import static com.google.v19.common.math.DoubleUtils.SIGNIFICAND_BITS;
import static com.google.v19.common.math.DoubleUtils.getSignificand;
import static com.google.v19.common.math.DoubleUtils.isFinite;
import static com.google.v19.common.math.DoubleUtils.isNormal;
import static com.google.v19.common.math.DoubleUtils.scaleNormalize;
import static com.google.v19.common.math.MathPreconditions.checkInRange;
...
import com.google.v19.common.primitives.Booleans;
...
public final class DoubleMath {
   ...
   */
  @GwtIncompatible("#isMathematicalInteger, com.google.v19.common.math.DoubleUtils")
   ...
   *                             </ul>
   */
  @GwtIncompatible("#roundIntermediate, java.lang.Math.getExponent, " + "com.google.v19.common.math.DoubleUtils")
   ...
   */
  @GwtIncompatible("com.google.v19.common.math.DoubleUtils")
   ...
   *                                  {@code x} is infinite
   */
  @GwtIncompatible("java.lang.Math.getExponent, com.google.v19.common.math.DoubleUtils")
  ...
  static final double[] everySixteenthFactorial = { 0x1.0p0, 0x1.30777758p44, 0x1.956ad0aae33a4p117,
      0x1.ee69a78d72cb6p202, 0x1.fe478ee34844ap295, 0x1.c619094edabffp394, 0x1.3638dd7bd6347p498, 0x1.7cac197cfe503p605,
  ...
  public static double mean(int... values) {
    checkArgument(values.length > 0, "Cannot take mean of 0 values");
    // The upper bound on the the length of an array and the bounds on the int
    // values mean that, in
