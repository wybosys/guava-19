...
package com.google.v19.common.math;
...
import static com.google.v19.common.math.MathPreconditions.checkNoOverflow;
import static com.google.v19.common.math.MathPreconditions.checkNonNegative;
import static com.google.v19.common.math.MathPreconditions.checkPositive;
import static com.google.v19.common.math.MathPreconditions.checkRoundingUnnecessary;
...
import com.google.v19.common.primitives.UnsignedLongs;
 ...
 * {@link com.google.v19.common.primitives.Longs}.
 *
...
public final class LongMath {
  ...
  static final byte[] maxLog10ForLeadingZeros = { 19, 18, 18, 18, 18, 17, 17, 17, 16, 16, 16, 15, 15, 15, 15, 14, 14,
      14, 13, 13, 13, 12, 12, 12, 12, 11, 11, 11, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4,
  ...
  static final long[] halfPowersOf10 = { 3L, 31L, 316L, 3162L, 31622L, 316227L, 3162277L, 31622776L, 316227766L,
      3162277660L, 31622776601L, 316227766016L, 3162277660168L, 31622776601683L, 316227766016837L, 3162277660168379L,
      31622776601683793L, 316227766016837933L, 3162277660168379331L };
  ...
  static final int[] biggestBinomials = { Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977,
      16175, 4337, 1733, 887, 534, 361, 265, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67,
      67, 66, 66, 66, 66 };
  ...
  static final int[] biggestSimpleBinomials = { Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251,
      11724, 3218, 1313, 684, 419, 287, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61,
      61 };
   ...
   *
   * NOTE: We could get slightly better bases that would be treated as unsigned,
  ...
  private enum MillerRabinTester {
    ...
    SMALL {
      ...
      long mulMod(long a, long b, long m) {
         ...
         * itself, and adding another enum constant hurts performance further -- I
         * suspect because bimorphic implementation is a sweet spot for the JVM.
         */
        return (a * b) % m;
      }
    ...
    LARGE {
      ...
      long squareMod(long a, long m) {
        ...
        /*
         * a^2 == aHi^2 * 2^64 + aHi * aLo * 2^33 + aLo^2 == (aHi^2 * 2^32 + aHi * aLo *
         * 2) * 2^32 + aLo^2 We carry out this computation in modular arithmetic. Since
         * times2ToThe32Mod accepts any unsigned long, we don't have to do a mod on
         * every operation, only when intermediate results can exceed 2^63.
         */
