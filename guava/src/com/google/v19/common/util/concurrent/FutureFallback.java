 ...
 * @author Bruno Diniz
 * @since 14.0
 * @deprecated This interface's main user,
 *             {@link Futures#withFallback(ListenableFuture, FutureFallback)
 *             Futures.withFallback}, has been updated to use
 *             {@link AsyncFunction}. We recommend that other APIs be updated in
 *             the same way. This interface will be removed in Guava release
 *             20.0.
 */
@Beta
@Deprecated
...
public interface FutureFallback<V> {
   ...
   *
   * @param t the exception that made the future fail. If the future's
   *          {@link Future#get() get} method throws an
   *          {@link ExecutionException}, then the cause is passed to this method.
