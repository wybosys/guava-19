 ...
 * itself be an {@code Error}; if not, use {@code ExecutionException} or
 * {@link UncheckedExecutionException}. This allows the client code to continue
 * to distinguish between exceptions and errors, even when they come from other
 * threads.
 *
 * @author Chris Povirk
 * @since 10.0
