...
final class FuturesGetChecked {
  ...
  static class GetCheckedTypeValidatorHolder {
    ...
    enum WeakSetValidator implements GetCheckedTypeValidator {
       ...
       * MapMaker map with weakKeys() and concurrencyLevel(1), even up to at least 12
       * cached exception types.
       */
      ...
      public void validateClass(Class<? extends Exception> exceptionClass) {
         ...
         * with more than a handful of exceptions. But it seems prudent to set a cap on
         * how many we'll cache. This avoids out-of-control memory consumption, and it
         * keeps the cache from growing so large that doing the lookup is noticeably
         * slower than redoing the work would be.
         *
         * Ideally we'd have a real eviction policy, but until we see a problem in
         * practice, I hope that this will suffice. I have not even benchmarked with
   ...
   * refer to it in the (static-method) Futures.getChecked documentation
   */
