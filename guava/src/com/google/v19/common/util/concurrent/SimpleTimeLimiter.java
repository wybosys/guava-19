...
import com.google.v19.common.collect.ObjectArrays;
...
public final class SimpleTimeLimiter implements TimeLimiter {
  ...
  /**
   * Constructs a TimeLimiter instance using the given executor service to execute
   * proxied method calls.
   * <p>
   * <b>Warning:</b> using a bounded executor may be counterproductive! If the
   * thread pool fills up, any time callers spend waiting for a thread may count
   * toward their time limit, and in this case the call may even time out before
   * the target method is ever invoked.
   *
