...
public final class ThreadFactoryBuilder {
   ...
   *                   format String, to which a unique integer (0, 1, etc.) will
   *                   be supplied as the single parameter. This integer will be
   *                   unique to the built instance of the ThreadFactory and will
   *                   be assigned sequentially. For example,
   *                   {@code "rpc-pool-%d"} will generate thread names like
   *                   {@code "rpc-pool-0"}, {@code "rpc-pool-1"},
   *                   {@code "rpc-pool-2"}, etc.
   ...
   *
   * @param daemon whether or not new Threads created with this ThreadFactory will
   *               be daemon threads
   * @return this for the builder pattern
   */
