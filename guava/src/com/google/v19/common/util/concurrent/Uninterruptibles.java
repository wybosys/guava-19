...
public final class Uninterruptibles {
  ...
  /**
   * Invokes {@code future.}{@link Future#get() get()} uninterruptibly. To get
   * uninterruptibility and remove checked exceptions, see
   * {@link Futures#getUnchecked}.
   *
   * <p>
   * If instead, you wish to treat {@link InterruptedException} uniformly with
   * other exceptions, see {@link Futures#getChecked(Future, Class)
   * Futures.getChecked}.
   *
   ...
   *                                  prevents it from being added to the given
   *                                  queue
