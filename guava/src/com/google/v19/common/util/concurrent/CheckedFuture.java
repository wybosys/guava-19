...
public interface CheckedFuture<V, X extends Exception> extends ListenableFuture<V> {
   ...
   * {@link ExecutionException} into application-specific exceptions. On timeout
   * this method throws a normal {@link TimeoutException}.
   *
   * @return the result of executing the future.
   * @throws TimeoutException if retrieving the result timed out.
   * @throws X                on interruption, cancellation or execution
   *                          exceptions.
   */
