...
public interface ListeningExecutorService extends ExecutorService {
     ...
     *
     * <p>
     * All elements in the returned list must be {@link ListenableFuture} instances.
     * The easiest way to obtain a {@code List<ListenableFuture<T>>} from this
     * method is an unchecked (but safe) cast:
     * 
     * <pre>
     ...
     * </pre>
     *
     * @return A list of {@code ListenableFuture} instances representing the tasks,
     *         in the same sequential order as produced by the iterator for the
     ...
     * @return a list of {@code ListenableFuture} instances representing the tasks,
     *         in the same sequential order as produced by the iterator for the
     *         given task list. If the operation did not time out, each task will
     *         have completed. If it did time out, some of these tasks will not have
     *         completed.
     * @throws RejectedExecutionException {@inheritDoc}
     * @throws NullPointerException       if any task is null
     */
