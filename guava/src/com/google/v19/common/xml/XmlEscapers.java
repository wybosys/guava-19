...
package com.google.v19.common.xml;
...
import com.google.v19.common.escape.Escapers;
...
public class XmlEscapers {
   ...
   *
   * <p>
   * This escaper substitutes {@code 0xFFFD} for non-whitespace control characters
   * and the character values {@code 0xFFFE} and {@code 0xFFFF} which are not
   * permitted in XML. For more detail see section
   * <a href="http://www.w3.org/TR/2008/REC-xml-20081126/#charsets">2.2</a> of the
   * XML specification.
   *
   * <p>
  ...
  static {
     ...
     * and to set the minimum safe character to 0x20. However this would slow down
     * the escaping of simple strings that contain \t, \n, or \r.
     */
