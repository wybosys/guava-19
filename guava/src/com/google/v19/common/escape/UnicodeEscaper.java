...
package com.google.v19.common.escape;
 ...
 * {@link com.google.v19.common.html.HtmlEscapers} and
 * {@link com.google.v19.common.xml.XmlEscapers}. To create your own escapers
 * extend this class and implement the {@link #escape(int)} method.
 *
...
public abstract class UnicodeEscaper extends Escaper {
   ...
   *
   * <p>
   * See {@link com.google.v19.common.net.PercentEscaper} for an example.
   *
   ...
   * {@link com.google.v19.common.net.PercentEscaper} more than doubled the
  ...
  protected static int codePointAt(CharSequence seq, int index, int end) {
    ...
    if (index < end) {
      ...
      if (c1 < Character.MIN_HIGH_SURROGATE || c1 > Character.MAX_LOW_SURROGATE) {
        ...
        throw new IllegalArgumentException("Expected low surrogate but got char '" + c2 + "' with value " + (int) c2
            + " at index " + index + " in '" + seq + "'");
      } else {
        throw new IllegalArgumentException("Unexpected low surrogate character '" + c1 + "' with value " + (int) c1
            + " at index " + (index - 1) + " in '" + seq + "'");
      }
    }
