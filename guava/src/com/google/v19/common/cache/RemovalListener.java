 ...
 * cache. The removal resulting in notification could have occured to an entry
...
public interface RemovalListener<K, V> {
   ...
   *
   * <p>
   * This does not always signify that the key is now absent from the cache, as it
   * may have already been re-added.
   */
