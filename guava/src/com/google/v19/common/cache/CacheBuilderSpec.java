...
public final class CacheBuilderSpec {
  ...
  private static final ImmutableMap<String, ValueParser> VALUE_PARSERS = ImmutableMap.<String, ValueParser>builder()
      ...
      .put("weakKeys", new KeyStrengthParser(Strength.WEAK)).put("softValues", new ValueStrengthParser(Strength.SOFT))
   ...
   * {@code CacheBuilderSpec}. The order and form of this representation is not
   * guaranteed, except that reparsing its output will produce a
  ...
  /**
   * Returns a string representation for this CacheBuilderSpec instance. The form
   * of this representation is not guaranteed.
   */
  @Override
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(initialCapacity, maximumSize, maximumWeight, concurrencyLevel, keyStrength, valueStrength,
        recordStats, durationInNanos(writeExpirationDuration, writeExpirationTimeUnit),
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    return Objects.equal(initialCapacity, that.initialCapacity) && Objects.equal(maximumSize, that.maximumSize)
        && Objects.equal(maximumWeight, that.maximumWeight) && Objects.equal(concurrencyLevel, that.concurrencyLevel)
  ...
  static class ConcurrencyLevelParser extends IntegerParser {
    @Override
    protected void parseInteger(CacheBuilderSpec spec, int value) {
      checkArgument(spec.concurrencyLevel == null, "concurrency level was already set to ", spec.concurrencyLevel);
