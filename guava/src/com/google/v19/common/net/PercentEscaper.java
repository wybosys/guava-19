...
import com.google.v19.common.escape.UnicodeEscaper;
 ...
 *
 * <p>
 * This class is primarily used for creating URI escapers in {@link UrlEscapers}
 * but can be used directly if required. While URI escapers impose specific
 * semantics on which characters are considered 'safe', this class has a minimal
 * set of restrictions.
 *
 * <p>
 ...
 * encoding and each byte is then represented by the 3-character string "%XX",
 * where "XX" is the two-digit, uppercase, hexadecimal representation of the
 * byte value.
 * </ul>
 *
 * <p>
 ...
 *
 * <p>
 * <b>Note:</b> This escaper produces uppercase hexadecimal sequences. From
...
public final class PercentEscaper extends UnicodeEscaper {
   ...
   *
   * <p>
   * Not that it is allowed, but not necessarily desirable to specify {@code %} as
   * a safe character. This has the effect of creating an escaper which has no
   * well defined inverse but it can be useful when escaping additional
   * characters.
   *
   * @param safeChars    a non null string specifying additional safe characters
   *                     for this escaper (the ranges 0..9, a..z and A..Z are
   *                     always safe and should not be specified here)
   * @param plusForSpace true if ASCII space should be escaped to {@code +} rather
   *                     than {@code %20}
   * @throws IllegalArgumentException if any of the parameters were invalid
   */
  public PercentEscaper(String safeChars, boolean plusForSpace) {
    // TODO(user): Switch to static factory methods for creation now that class is
    // final.
    ...
    safeChars += "abcdefghijklmnopqrstuvwxyz" + "ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "0123456789";
