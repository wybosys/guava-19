...
import com.google.v19.common.util.concurrent.MoreExecutors;
 ...
 * queue it for later. (For a convenient way to do this, use an
 * {@link AsyncEventBus}.)
 *
 ...
 * Accordingly, while DeadEvent extends {@link Object}, a subscriber registered
 * to receive any Object will never receive a DeadEvent.
 *
 * <p>
...
public class EventBus {
   ...
   *
   * @param identifier a brief name for this bus, for logging purposes. Should be
  ...
  void handleSubscriberException(Throwable e, SubscriberExceptionContext context) {
    ...
    try {
      ...
      logger.log(Level.SEVERE, String.format(Locale.ROOT, "Exception %s thrown while handling exception: %s", e2, e),
          e2);
    }
  }
