 ...
 * {@link com.google.v19.common.eventbus.Subscribe} annotation.</li>
 * </ul>
 *
 * <p>
 ...
 * possible producer, you must also know its type.</li>
 * <li><strong>...with EventBus:</strong> pass your object to the
 * {@link com.google.v19.common.eventbus.EventBus#register(Object)} method on an
 * EventBus. You'll need to make sure that your object shares an EventBus
 * instance with the event producers.</li>
 * </ul>
 *
 * <p>
 ...
 * "wildcard listeners" for Object.</li>
 * </ul>
 *
 * <p>
 ...
 * {@link com.google.v19.common.eventbus.DeadEvent}. The EventBus will notify
 * you of any events that were posted but not delivered. (Handy for
 * debugging.)</li>
 * </ul>
 *
 * <h3>For Producers</h3>
 ...
 * class like EventListenerList.</li>
 ...
 * desired) asynchronicity.</li>
 * <li><strong>...with EventBus:</strong> pass the event object to an EventBus's
 * {@link com.google.v19.common.eventbus.EventBus#post(Object)} method.</li>
 * </ul>
 *
 * <h2>Glossary</h2>
 *
