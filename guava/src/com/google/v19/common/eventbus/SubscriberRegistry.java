...
package com.google.v19.common.eventbus;
...
import com.google.v19.common.cache.CacheBuilder;
import com.google.v19.common.cache.CacheLoader;
import com.google.v19.common.cache.LoadingCache;
import com.google.v19.common.collect.HashMultimap;
...
import com.google.v19.common.reflect.TypeToken;
...
final class SubscriberRegistry {
  ...
  void unregister(Object listener) {
    ...
    for (Map.Entry<Class<?>, Collection<Subscriber>> entry : listenerMethods.asMap().entrySet()) {
      ...
      if (currentSubscribers == null || !currentSubscribers.removeAll(listenerMethodsForType)) {
        // if removeAll returns true, all we really know is that at least one subscriber
        // was
        // removed... however, barring something very strange we can assume that if at
        // least one
  ...
  /**
   * A thread-safe cache that contains the mapping from each class to all methods
   * in that class and all super-classes, that are annotated with
   * {@code @Subscribe}. The cache is shared across all instances of this class;
   * this greatly improves performance if multiple EventBus instances are created
   * and objects of the same class are registered on all of them.
   */
