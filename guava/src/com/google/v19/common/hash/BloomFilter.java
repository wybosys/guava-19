...
import com.google.v19.common.hash.BloomFilterStrategies.BitArray;
import com.google.v19.common.primitives.SignedBytes;
import com.google.v19.common.primitives.UnsignedBytes;
...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
   ...
   * (not Java serialization). This has been measured to save at least 400 bytes
   * compared to regular serialization.
   *
   * <p>
  ...
  public void writeTo(OutputStream out) throws IOException {
    /*
     * Serial form: 1 signed byte for the strategy 1 unsigned byte for the number of
     * hash functions 1 big endian int, the number of longs in our bitset N big
     * endian longs of our bitset
     */
   ...
   *                     its data does not appear to be a BloomFilter serialized
   *                     using the {@linkplain #writeTo(OutputStream)} method.
   */
  @CheckReturnValue
  public static <T> BloomFilter<T> readFrom(InputStream in, Funnel<T> funnel) throws IOException {
    ...
    try {
      ...
      IOException ioException = new IOException(
          "Unable to deserialize BloomFilter from InputStream." + " strategyOrdinal: " + strategyOrdinal
              + " numHashFunctions: " + numHashFunctions + " dataLength: " + dataLength);
