...
abstract class AbstractStreamingHashFunction implements HashFunction {
  ...
  protected static abstract class AbstractStreamingHasher extends AbstractHasher {
     ...
     *
     * While intuitively, using CharsetEncoder to encode the CharSequence directly
     * to the buffer (or even to an intermediate buffer) should be considerably more
     * efficient than potentially copying the CharSequence to a String and then
     * calling getBytes(Charset) on that String, in reality there are optimizations
     * that make the getBytes(Charset) approach considerably faster, at least for
     * commonly used charsets like UTF-8.
     */
