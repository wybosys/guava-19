 ...
 *
 * <p>
 * <b>Grouped iteration.</b> In all current implementations, duplicate elements
 * always appear consecutively when iterating. Elements iterate in order by the
 * <i>first</i> appearance of that element when the multiset was created.
 *
 * <p>
...
public abstract class ImmutableMultiset<E> extends ImmutableCollection<E> implements Multiset<E> {
  ...
  public static <E> ImmutableMultiset<E> copyOf(Iterable<? extends E> elements) {
    ...
    Multiset<? extends E> multiset = (elements instanceof Multiset) ? Multisets.cast(elements)
  ...
  public static class Builder<E> extends ImmutableCollection.Builder<E> {
    ...
    /**
     * Returns a newly-created {@code ImmutableMultiset} based on the contents of
     * the {@code Builder}.
     */
    @Override
