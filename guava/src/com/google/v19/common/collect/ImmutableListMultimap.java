...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
  ...
  /**
   * Returns an immutable list of the values for the given key. If no mappings in
   * the multimap have the provided key, an empty immutable list is returned. The
   ...
   *
   * <p>
   * Because an inverse of a list multimap can contain multiple pairs with the
   * same key and value, this method returns an {@code
   * ImmutableListMultimap} rather than the {@code ImmutableMultimap} specified in
   * the {@code ImmutableMultimap} class.
   *
   * @since 11.0
   */
  @Override
