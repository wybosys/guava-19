...
import static com.google.v19.common.collect.BoundType.CLOSED;
import static com.google.v19.common.collect.BoundType.OPEN;
...
final class GeneralRange<T> implements Serializable {
  ...
  public boolean equals(@Nullable Object obj) {
    if (obj instanceof GeneralRange) {
      ...
      return comparator.equals(r.comparator) && hasLowerBound == r.hasLowerBound && hasUpperBound == r.hasUpperBound
          && getLowerBoundType().equals(r.getLowerBoundType()) && getUpperBoundType().equals(r.getUpperBoundType())
  ...
  public String toString() {
    return new StringBuilder().append(comparator).append(":").append(lowerBoundType == CLOSED ? '[' : '(')
        .append(hasLowerBound ? lowerEndpoint : "-\u221e").append(',').append(hasUpperBound ? upperEndpoint : "\u221e")
