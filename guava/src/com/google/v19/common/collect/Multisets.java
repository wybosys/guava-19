...
import com.google.v19.common.collect.Multiset.Entry;
...
public final class Multisets {
   ...
   * @return {@code true} if {@code multisetToModify} was changed as a result of
   *         this operation
   * @since 18.0 (present in 10.0 with a requirement that the second parameter be
   *        a {@code Multiset})
   */
  ...
  static boolean removeAllImpl(Multiset<?> self, Collection<?> elementsToRemove) {
    Collection<?> collection = (elementsToRemove instanceof Multiset) ? ((Multiset<?>) elementsToRemove).elementSet()
        : elementsToRemove;
  ...
  static boolean retainAllImpl(Multiset<?> self, Collection<?> elementsToRetain) {
    ...
    Collection<?> collection = (elementsToRetain instanceof Multiset) ? ((Multiset<?>) elementsToRetain).elementSet()
        : elementsToRetain;
