...
import static com.google.v19.common.collect.ObjectArrays.checkElementsNotNull;
...
/**
 * A {@link NavigableSet} whose contents will never change, with many other
...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E>
  ...
  private static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<Comparable>(
  ...
  public static final class Builder<E> extends ImmutableSet.Builder<E> {
    ...
    /**
     * Returns a newly-created {@code ImmutableSortedSet} based on the contents of
     * the {@code Builder} and its comparator.
     */
    @Override
   ...
   * {@link Ordering#natural()} when the natural ordering of the elements is used.
   * Note that its behavior is not consistent with {@link SortedSet#comparator()},
   ...
   *
   * <p>
   * The {@link SortedSet#headSet} documentation states that a subset of a subset
   * throws an {@link IllegalArgumentException} if passed a {@code toElement}
   * greater than an earlier {@code toElement}. However, this method doesn't throw
   * an exception in that situation, but instead keeps the original
   * {@code toElement}.
   */
  @Override
