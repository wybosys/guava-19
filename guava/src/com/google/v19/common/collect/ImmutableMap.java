...
/**
 * A {@link Map} whose contents will never change, with many other important
...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
  ...
  public static class Builder<K, V> {
     ...
     * equivalent, the entry that was inserted first will be first in the built
  ...
  private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
    ...
    @Override
    public int hashCode() {
      // ImmutableSet.of(value).hashCode() == value.hashCode(), so the hashes are the
      // same
