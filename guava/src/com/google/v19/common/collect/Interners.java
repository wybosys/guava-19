...
import com.google.v19.common.collect.MapMakerInternalMap.ReferenceEntry;
...
public final class Interners {
   ...
   * perform better than {@link #newWeakInterner}. Note that unlike
   ...
   * {@link #newStrongInterner}, but is the best alternative when the memory usage
   * of that implementation is unacceptable. Note that unlike
   * {@link String#intern}, using this interner does not consume memory in the
   * permanent generation.
   */
  ...
  private static class WeakInterner<E> implements Interner<E> {
    ...
    private final MapMakerInternalMap<E, Dummy> map = new MapMaker().weakKeys().keyEquivalence(Equivalence.equals())
        .makeCustomMap();
