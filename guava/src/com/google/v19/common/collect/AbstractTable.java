  ...
  class CellSet extends AbstractSet<Cell<R, C, V>> {
    ...
    public boolean contains(Object o) {
      if (o instanceof Cell) {
        ...
        return row != null
            && Collections2.safeContains(row.entrySet(), Maps.immutableEntry(cell.getColumnKey(), cell.getValue()));
      }
      return false;
    }
    ...
    public boolean remove(@Nullable Object o) {
      if (o instanceof Cell) {
        ...
        Map<C, V> row = Maps.safeGet(rowMap(), cell.getRowKey());
        return row != null
            && Collections2.safeRemove(row.entrySet(), Maps.immutableEntry(cell.getColumnKey(), cell.getValue()));
      }
      return false;
    }
