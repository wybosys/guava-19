...
public final class ObjectArrays {
   ...
   *         contents as {@code array}, plus {@code element} occupying the last
   *         position.
   */
  ...
  /**
   * Implementation of {@link Collection#toArray(Object[])} for collections backed
   * by an object array. the runtime type of the returned array is that of the
   ...
   * of the specified array and the size of the specified collection.
   *
   * <p>
   * If the collection fits in the specified array with room to spare (i.e., the
   * array has more elements than the collection), the element in the array
