...
import static com.google.v19.common.base.Predicates.compose;
...
import com.google.v19.common.base.Converter;
...
import com.google.v19.common.base.Predicates;
import com.google.v19.common.collect.MapDifference.ValueDifference;
...
public final class Maps {
   ...
   *
   * <p>
   * It is preferable to use {@code MapMaker} directly (rather than through this
   * method), as it presents numerous useful configuration options, such as the
   * concurrency level, load factor, key/value reference types, and value
   * computation.
   *
    ...
    public boolean equals(Object object) {
      ...
      if (object instanceof MapDifference) {
        ...
        return entriesOnlyOnLeft().equals(other.entriesOnlyOnLeft())
            ...
            && entriesInCommon().equals(other.entriesInCommon()) && entriesDiffering().equals(other.entriesDiffering());
      }
      return false;
    }
   ...
   * whether {@code valueFunction} will be applied to more than one instance of
   * that key and, if it is, which result will be mapped to that key in the
   * returned map.
   *
   * <p>
   ...
   * whose key is the result of applying {@code keyFunction} to that value. These
   * entries appear in the same order as the input values. Example usage:
   * 
   * <pre>
   *    {@code
   *
   ...
   * {@link com.google.v19.common.base.Functions#forMap(Map)} or
   * {@link com.google.v19.common.base.Functions#forMap(Map, Object)}.
   *
   * @since 16.0
   */
  @Beta
  ...
  static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
    ...
    Iterator<Entry<K, V2>> entryIterator() {
      return Iterators.transform(fromMap.entrySet().iterator(), Maps.<K, V1, V2>asEntryToEntryFunction(transformer));
    }
