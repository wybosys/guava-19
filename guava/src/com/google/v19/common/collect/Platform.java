...
import com.google.v19.common.collect.Maps.EntryTransformer;
...
final class Platform {
   ...
   * otherwise (i.e., in GWT). This is sometimes acceptable, when only server-side
   * code could generate enough volume that reclamation becomes important.
   */
