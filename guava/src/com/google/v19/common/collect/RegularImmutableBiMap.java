...
import static com.google.v19.common.collect.ImmutableMapEntry.createEntryArray;
import static com.google.v19.common.collect.RegularImmutableMap.checkNoConflictInKeyBucket;

import com.google.v19.common.annotations.GwtCompatible;
import com.google.v19.common.collect.ImmutableMapEntry.NonTerminalImmutableBiMapEntry;
...
class RegularImmutableBiMap<K, V> extends ImmutableBiMap<K, V> {
  ...
  static <K, V> RegularImmutableBiMap<K, V> fromEntryArray(int n, Entry<K, V>[] entryArray) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (nextInValueBucket == null && nextInKeyBucket == null) {
         ...
         * bytes on some platforms, but 2-morphic call sites are often optimized much
         * better than 3-morphic, so it'd require benchmarking.
         */
  ...
  ImmutableSet<Entry<K, V>> createEntrySet() {
    return isEmpty() ? ImmutableSet.<Entry<K, V>>of() : new ImmutableMapEntrySet.RegularEntrySet<K, V>(this, entries);
  }
