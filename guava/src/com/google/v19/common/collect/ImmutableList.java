...
import static com.google.v19.common.collect.ObjectArrays.arraysCopyOf;
import static com.google.v19.common.collect.ObjectArrays.checkElementsNotNull;
import static com.google.v19.common.collect.RegularImmutableList.EMPTY;
...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
   ...
   * returns an {@code ImmutableList<List<String>>} containing one element (the
   * given list itself).
   *
   * <p>
  ...
  /**
   * Views the array as an immutable list. Copies if the specified range does not
   * cover the complete array. Does not check for nulls.
   */
