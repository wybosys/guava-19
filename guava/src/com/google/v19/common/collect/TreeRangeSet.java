...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> {
    ...
    Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
      ...
      return new AbstractIterator<Entry<Cut<C>, Range<C>>>() {
        ...
        protected Entry<Cut<C>, Range<C>> computeNext() {
          ...
          Range<C> range = backingItr.next();
          return upperBoundWindow.lowerBound.isLessThan(range.upperBound) ? Maps.immutableEntry(range.upperBound, range)
              : endOfData();
        }
      };
    }
  ...
  private static final class ComplementRangesByLowerBound<C extends Comparable<?>>
    ...
    Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
       ...
       */
      Cut<C> startingPoint = complementLowerBoundWindow.hasUpperBound() ? complementLowerBoundWindow.upperEndpoint()
          : Cut.<C>aboveAll();
    ...
    Iterator<Entry<Cut<C>, Range<C>>> entryIterator() {
      ...
      if (lowerBoundWindow.upperBound.isLessThan(restriction.lowerBound)) {
        ...
        completeRangeItr = rangesByLowerBound
            .tailMap(lowerBoundWindow.lowerBound.endpoint(), lowerBoundWindow.lowerBoundType() == BoundType.CLOSED)
            .values().iterator();
      }
  ...
  private final class SubRangeSet extends TreeRangeSet<C> {
    ...
    SubRangeSet(Range<C> restriction) {
      super(
          new SubRangeSetRangesByLowerBound<C>(Range.<Cut<C>>all(), restriction, TreeRangeSet.this.rangesByLowerBound));
