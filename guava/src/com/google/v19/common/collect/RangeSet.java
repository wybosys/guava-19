...
public interface RangeSet<C extends Comparable> {
  ...
  /**
   * Returns a descending view of the {@linkplain Range#isConnected disconnected}
   * ranges that make up this range set. The returned set may be empty. The
   * iterators returned by its {@link Iterable#iterator} method return the ranges
   * in decreasing order of lower bound (equivalently, of upper bound).
   *
   * @since 19.0
   */
   ...
   * {@code Range.greaterThan(4)}, this might return {@code " [1‥3](4‥+∞)}"}.
   */
  @Override
  String toString();
}
