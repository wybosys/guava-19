 ...
 * {@link ImmutableSortedMultiset} equivalents with deprecated,
 ...
 *
 * <p>
 * While we could put the overrides in {@link ImmutableSortedMultiset} itself,
 * it seems clearer to separate these "do not call" methods from those intended
 * for normal use.
 *
...
abstract class ImmutableSortedMultisetFauxverideShim<E> extends ImmutableMultiset<E> {
  /**
   * Not supported. Use {@link ImmutableSortedMultiset#naturalOrder}, which offers
   ...
   * @deprecated Use {@link ImmutableSortedMultiset#naturalOrder}, which offers
   *             better type-safety.
   */
  @Deprecated
   ...
   * "<E extends Comparable<E>> copyOf(Iterable<E>)" in ImmutableSortedMultiset
   * (and likewise for the Iterator equivalent). However, due to a change in Sun's
   ...
   * ImmutableSortedMultiset matches that in ImmutableMultiset.
   *
   * The result is that ImmutableSortedMultiset.copyOf() may be called on
   ...
   * so that ImmutableSortedMultiset wouldn't "inherit" too-permissive factory
