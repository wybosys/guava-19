    ...
    public Map<Range<K>, V> asDescendingMapOfRanges() {
      return new SubRangeMapAsMap() {
        ...
        Iterator<Entry<Range<K>, V>> entryIterator() {
          ...
          final Iterator<RangeMapEntry<K, V>> backingItr = entriesByLowerBound.headMap(subRange.upperBound, false)
    ...
    class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
      ...
      Iterator<Entry<Range<K>, V>> entryIterator() {
        ...
        Cut<K> cutToStart = MoreObjects.firstNonNull(entriesByLowerBound.floorKey(subRange.lowerBound),
            subRange.lowerBound);
        final Iterator<RangeMapEntry<K, V>> backingItr = entriesByLowerBound.tailMap(cutToStart, true).values()
            .iterator();
        return new AbstractIterator<Entry<Range<K>, V>>() {
