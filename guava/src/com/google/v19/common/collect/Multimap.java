...
public interface Multimap<K, V> {
   ...
   * have the same hash codes, depending on the implementation. For example, two
   * {@link SetMultimap} instances with the same key-value mappings will have the
   * same {@code hashCode}, but the {@code hashCode} of {@link ListMultimap}
