 ...
 * <a href= "https://github.com/google/guava/wiki/FunctionalExplained">the use
 * of {@code
 * Function}</a>.
 *
 * @author Mike Bostock
...
public final class Functions {
   ...
   *
   * <p>
   * Note: if {@code map} is a {@link com.google.v19.common.collect.BiMap BiMap}
   * (or can be one), you can use
   * {@link com.google.v19.common.collect.Maps#asConverter Maps.asConverter}
