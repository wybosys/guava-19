...
package com.google.v19.common.base.internal;
 ...
 * {@code com.google.v19.common.base.FinalizableReference}.
 *
 * <p>
 ...
 *
 * <p>
 * {@code com.google.v19.common.base.FinalizableReferenceQueue} loads this class
 * in its own class loader. That way, this class doesn't prevent the main class
...
public class Finalizer implements Runnable {
  ...
  private static final String FINALIZABLE_REFERENCE = "com.google.v19.common.base.FinalizableReference";
   ...
   * @param frqReference              a phantom reference to the
   *                                  FinalizableReferenceQueue, which will be
   *                                  queued either when the
   *                                  FinalizableReferenceQueue is no longer
   *                                  referenced anywhere, or when its close()
   *                                  method is called.
   */
  ...
  private Method getFinalizeReferentMethod() {
    ...
    if (finalizableReferenceClass == null) {
       ...
       * reference to it), we should pretty much just shut down and make sure we don't
