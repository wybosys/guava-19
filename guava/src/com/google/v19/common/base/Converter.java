 ...
 * {@link com.google.v19.common.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 * {@link com.google.v19.common.primitives.Ints#stringConverter
 * Ints.stringConverter} or the {@linkplain #reverse reverse} views of these.
 * <li>Convert between specific preset values using
 * {@link com.google.v19.common.collect.Maps#asConverter Maps.asConverter}. For
 ...
 * <li>If using Java 8, you may prefer to pass two lambda expressions or method
 * references to {@link #from}.
 * </ul>
 *
 * <p>
 * Using a converter:
