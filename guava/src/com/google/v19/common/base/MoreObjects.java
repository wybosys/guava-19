...
public final class MoreObjects {
   ...
   * be accomplished with {@link Optional#or(Object) first.or(second)}. That
   * approach also allows for lazy evaluation of the fallback instance, using
   * {@link Optional#or(Supplier) first.or(supplier)}.
   *
   * @return {@code first} if it is non-null; otherwise {@code second} if it is
   *         non-null
