 ...
 * <a href= "https://github.com/google/guava/wiki/StringsExplained#charmatcher">
 * {@code CharMatcher}</a>.
 *
...
public abstract class CharMatcher implements Predicate<Character> {
   ...
   *
   * <p>
   * <b>Note:</b> as the Unicode definition evolves, we will modify this matcher
   ...
   * match ASCII digits, you can use {@code inRange('0',
   * '9')}.
   *
   ...
   *
   * <p>
   * <b>Note:</b> as the reference file evolves, we will modify this matcher to
   * keep it up to date.
   *
  ...
  /**
   * Returns the Java Unicode escape sequence for the given character, in the form
   * "\u12AB" where "12AB" is the four hexadecimal digits representing the 16 bits
