...
public final class Suppliers {
   ...
   * will be invoked at most once. The supplier's serialized form does not contain
   * the cached value, which will be recalculated when {@code get()} is called on
   * the reserialized instance.
   *
   * <p>
