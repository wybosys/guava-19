...
import static com.google.v19.common.math.IntMath.divide;
import static com.google.v19.common.math.IntMath.log2;
...
public abstract class BaseEncoding {
  // TODO(lowasser): consider making encodeTo(Appendable, byte[], int, int)
  // public.
    ...
    int decode(char ch) throws DecodingException {
      if (ch > Ascii.MAX || decodabet[ch] == -1) {
        throw new DecodingException(
            "Unrecognized character: " + (CharMatcher.INVISIBLE.matches(ch) ? "0x" + Integer.toHexString(ch) : ch));
      }
      return decodabet[ch];
    }
