...
package com.google.v19.common.html;
 ...
 * provide autoescaping. One Google-authored templating system available for
 * external use is
 * <a href="https://developers.google.com/closure/templates/">Closure
 * Templates</a>.
 *
 * <p>
 * HTML escaping is particularly tricky: For example,
 * <a href="http://goo.gl/5TgZb">some elements' text contents must not be HTML
